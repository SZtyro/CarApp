...
const routes: Routes = [
  ...
  { path: 'login', component: LoginComponent},
  {
    ...
    children: [
      ...
      MenuService.standard('Roles', RoleComponent, RoleService),
      MenuService.standard('Cars', CarFormComponent, CarService),
      MenuService.standard('Tires', TireComponent, TireService),
      MenuService.standard('InsuranceCompanies', InsuranceCompanyComponent, InsuranceCompanyService),
      MenuService.standard('TireCompanies',TireCompanyFormComponent, TireCompanyService),
