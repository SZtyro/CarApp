...
@AutoConfiguration
@EnableJpaRepositories({"pl.sztyro.carapp.repository", "pl.sztyro.core.repository", "pl.sztyro.core.interfaces"})
@EntityScan({"pl.sztyro.carapp.model", "pl.sztyro.core.model"})
